...
export const userItemProgress = sqliteTable("user_item_progress", {
  ...
  status: text("status", { enum: ["new", "learning", "reviewing", "mastered", "difficult"] }).notNull().default("new"),
...
export const practiceAttempts = sqliteTable("practice_attempts", {
  ...
  practiceType: text("practice_type", {
    enum: ["flashcard", "multiple_choice", "match_pairs", "type_answer", "fill_blank", "sentence_reorder"],
  }).notNull(),
