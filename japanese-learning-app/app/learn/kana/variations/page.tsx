...
export default function VariationsPage() {
  const items = learningItems.filter((item) => item.metadata.variationType !== "basic");

  return (
    <AppShell>
      <div className="space-y-6">
        <div><Badge variant="secondary" className="mb-3 rounded-md">Kana</Badge><h1 className="text-3xl font-semibold">Variations</h1></div>
